	...
	<body>
		...
		<div id="content" class="row">
			<div class="large-12 columns">
				...
				<p class="middle_text" >La collaboration de l’E2C Grand Hainaut avec les acteurs économiques des territoires Sambre-Avesnois et <strong class="bold">Valenciennois</strong> est I.N.D.I.S.P.E.N.S.A.B.L.E. !</p>
				<table>
					<tbody>
						<tr>
						...
						<tr>
							<td class="partnership_border" ><p class="compulsory" ><span class="orange">Elle est un appui au <span class="achievement" >développement de l’<strong class="bold" >Ecole</strong></span>.</span><br />
							Le soutien financier, matériel et humain permet ainsi de s'associer aux efforts de l’E2C, à participer toujours plus activement à l’insertion professionnelle durable de nos stagiaires.</p>
							</td>	
						</tr>
					</tbody>
				</table>				
				...
				<table>
					<tbody>
						...
						<tr>
							<td class="recieve_border" ><span class="green bold" >■ Embauche</span>
							<br />
							Vous êtes à la recherche de collaborateurs motivés ? Notre stagiaire vous a séduit lors de son <strong>stage</strong> ? Saisissez l’opportunité de recruter un de nos jeunes en lui proposant un CDD, un CDI ou un contrat en alternance.<br />
							</td>	
						</tr>
				...
				<table class="report_border" >
					<tbody>
						<tr>
							...
							<br /> 
							Ce type de rencontre, programmée sur chacun de nos sites, permet de sensibiliser et d’informer nos stagiaires sur le (ou les) métier(s) représenté(s) dans votre entreprise.
						</tr>
						<tr>
							<td><span class="orange bold" >■ Visite d’entreprise</span> 
							<br /> 
							Sur le même principe qu’une rencontre « métiers », les stagiaires ont ici l’opportunité de découvrir le quotidien d’une entreprise ou d’un service.
							</td>	
						</tr>
					</tbody>
				</table>
				<h4 class="accompany" ><span class="accompany_bg">Accompagnez...</span></h4>
				<table class="accompany_border" >
					<tbody>
						...
						<tr>
							...
							<br /> 
							Faites profiter de votre expérience et de votre expertise ! En accompagnant régulièrement votre filleul - stagiaire de l’E2C -, vous l’aidez dans ses démarches d’insertion professionnelle (coaching, accès à un réseau d’entreprises, etc.).
							</td>	
						</tr>
						<tr>
				...
				<table class="finance_border" >
					<tbody>
						<tr>
							...
							<br /> 
							Soutenez notre <strong>Ecole</strong> grâce à vos dons ! Qu’il s’agisse de mécénat financier, matériel ou de compétences, votre contribution est un signe fort d’engagement et de confiance.
							</td>
						</tr>
						<tr>
