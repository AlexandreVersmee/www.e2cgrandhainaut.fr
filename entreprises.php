...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	<head>
		<meta charset="utf-8" />
		<title>Ecole de la 2e Chance Grand Hainaut - Entreprises</title>
		<?php include './includes/header_meta_link.html'; ?>
		<link rel="stylesheet" media="screen" type="text/css" href="css/entreprises.css" >
	</head>
	...
	<body>
		...
		<div id="content" class="row">
			<div class="large-12 columns">
				<h3 class="page_title" >Entreprises</h3>
				<p class="middle_text" >Votre collaboration est DETERMINANTE...</p>
				<table>
					<tbody>
						<tr>
							<td class="partnership_border" >
								<span class="orange bold" >... pour la réussite du jeune dans son parcours à l’E2C Grand Hainaut</span><br />
								La structuration de son projet professionnel doit s’appuyer sur une confrontation directe et régulière avec la réalité
								du monde du travail.<br />
								Visiter une entreprise, s’informer sur les métiers, valider les représentations de ces métiers lors de stages… sont autant
								d’étapes qui lui permettront de conforter son projet tout au long de sa formation.
							</td>	
						</tr>
						<tr>
							<td class="partnership_border" >
 								<p class="compulsory">
 									<span class="orange bold">... au développement de notre Ecole</span><br/>
									Le soutien financier, matériel et humain permet ainsi de valoriser les efforts de l’E2C Grand Hainaut à participer toujours
									plus activement à l’insertion sociale, citoyenne et professionnelle durable de nos stagiaires tout en apportant une réponse
									à vos besoins.
								</p>
							</td>	
						</tr>
				...
				<h4 class="recieve" ><span class="recieve_bg">Accueillez...</span></h4>
				<table>
					<tbody>
						<tr>
							<td class="recieve_border" ><span class="green" ><strong class="bold" >■ Stage, immersion</strong></span>
							<br /> 
							De la découverte du monde professionnel, d’un métier à l’acquisition de compétences, <span class="bold">des périodes d’immersion en entreprise / en
							centre de formation modulables</span> (de quelques jours à 4 semaines) sont planifiées tout au long du parcours du jeune afin d’amener ce
							dernier à conforter son projet professionnel puis à développer les savoir-être et savoir-faire nécessaires à son insertion durable dans le
							monde du travail.
							</td>	
						</tr>
						<tr>
							<td class="recieve_border" ><span class="green bold" >■ Embauche, formation</span>
							<br />
							Vous êtes à la recherche de candidats motivés ? Saisissez l’opportunité de recruter / de former un de nos jeunes en lui proposant un em
							ploi et/ou une formation. <br/><span class="bold">Notre « Pôle Partenariats » est votre disposition pour vous informer des mesures et aides existantes et vous accompagner dans vos démarches.</span>
							<br />
							</td>	
						</tr>
						<tr><td class="name_link_cv hide-for-small"><a href="vitrine.php" ><img src="images/icones/action_arrow.png" />Cliquez sur CV pour découvrir les talents de nos jeunes stagiaires !<br /><center><img src="images/icones/cvtheque.png" title="Recrutez nos jeunes !" alt="Logo de l'E2C Grand Hainaut" /></center></a></td></tr>
					</tbody>
				</table>
				<h4 class="report" ><span class="report_bg">Informez...</span></h4>
				<table class="report_border" >
					<tbody>
						<tr>
							<td><span class="orange bold" >■ Rencontre « métiers »</span> 
							<br /> 
							Ce type de rencontre, programmée sur notre site, permet de <span class="bold">sensibiliser et d’informer nos stagiaires sur les métiers / formations représenté(s) dans votre entreprise ou centre de formation</span>
						</tr>
						<tr>
							<td><span class="orange bold" >■ Visite de votre structure</span> 
							<br /> 
							Sur le même principe qu’une rencontre « métiers », <span class="bold">les stagiaires ont ici l’opportunité de découvrir le quotidien de votre entreprise ou de votre centre de formation : visite d’atelier, témoignage de salariés/de formateurs, démonstrations, etc.</span>
							</td>	
						</tr>
					</tbody>
				</table>
                ...
                <table class="accompany_border">
                    ...
                    <tr>
						...
						<tr>
							...
							<br /> 
							Chaque vendredi après-midi, <span class="bold">en jouant le rôle de recruteur, vous évaluez puis conseillez le stagiaire sur sa manière de se comporter lors d’un entretien d’embauche</span> : attitudes, capacités à présenter son parcours, à motiver sa candidature, à répondre aux questions « pièges », etc.

							<br/><img src="images/icones/action_arrow_mini.png" /> <span class="purple bold" >Pour y participer, téléchargez et complétez la fiche suivante :</span> Anzin <a target="_blank" href="fiches/fiche_simulation_entretien.pdf" title="Téléchargement de la fiche de participation aux ateliers de simulation d'entretien du site d'Anzin" /><img src="images/icones/pdf_32.png" title="Téléchargement de la fiche de participation aux ateliers de simulation d'entretien du site d'Anzin" alt="Logo de pdf" /></a>
							</td>	
						</tr>
						<tr>
							<td><span class="purple bold" >■ Parrainage</span>
							<br /> 
