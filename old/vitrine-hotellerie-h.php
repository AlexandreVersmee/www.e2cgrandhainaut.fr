...
<div id="content" class="row">
    <div class="large-12 columns">
        ...
        <p class="title"><span class="underline"><span class="green">Hôtellerie</span> <span class="orange">restauration</span>  - <span
                        class=purple>Profil 1</span></span></p>
        ...
        <div class="middl">
            ...
            <table class="mover_metier metier" id="tab_metier" width="305" height="188" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td colspan="3"><img src="images/cvtheque/rubriques/metier/hotellerie/hotellerie_01.png" width="305" height="2" alt=""></td>
                </tr>
                <tr>
                    ...
                    <td><img onmouseover="$('#tab_metier').addClass('stopAnim');$('#metier').show('blind', 500);"
                             ...
                             src="images/cvtheque/rubriques/metier/hotellerie/hotellerie_03.png" width="151" height="58" alt=""></td>
                    <td rowspan="2"><img src="images/cvtheque/rubriques/metier/hotellerie/hotellerie_04.png" width="152" height="186" alt=""></td>
                </tr>
                <tr>
                    <td><img src="images/cvtheque/rubriques/metier/hotellerie/hotellerie_05.png" width="151" height="128" alt=""></td>
                </tr>
            </table>
